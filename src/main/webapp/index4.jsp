...
<body>
    <div class="header_con">
        <div class="header">
            ...
            <ul class="menu fl">
                ...
                <li class="active" data-cid="3"><a href="javascript:;">军事</a></li>
	...
	List<News> list = newsDao.searchNewsBySectionTopTen(4);
    ...
    <div class="conter_con">
        <ul class="list_con fl">
            ...
            <li id="news0">
                <a href="detail.jsp?num=${ newsId[0] }" class="news_pic fl"><img src="images/s401.jpg"></a>
            ...
            <li id="news1">
                <a href="detail.jsp?num=${ newsId[1] }" class="news_pic fl"><img src="images/s402.jpeg"></a>
            ...
            <li id="news2">
                <a href="detail.jsp?num=${ newsId[2] }" class="news_pic fl"  ><img src="images/s403.jpg"></a>
            ...
            <li id="news3">
                <a href="detail.jsp?num=${ newsId[3] }" class="news_pic fl"><img src="images/s404.jpg"></a>
            ...
            <li id="news4">
                <a href="detail.jsp?num=${ newsId[4] }" class="news_pic fl"><img src="images/s405.jpg"></a>
            ...
            <li id="news5">
                <a href="detail.jsp?num=${ newsId[5] }" class="news_pic fl"><img src="images/s406.jpg"></a>
            ...
            <li id="news6">
                <a href="detail.jsp?num=${ newsId[6] }" class="news_pic fl"><img src="images/s407.jpg"></a>
            ...
            <li id="news7">
                <a href="detail.jsp?num=${ newsId[7] }" class="news_pic fl"><img src="images/s408.jpg"></a>
            ...
            <li id="news8">
                <a href="detail.jsp?num=${ newsId[8] }" class="news_pic fl"><img src="images/s409.jpg"></a>
            ...
            <li id="news9">
                <a href="detail.jsp?num=${ newsId[9] }" class="news_pic fl"><img src="images/s410.jpg"></a>
