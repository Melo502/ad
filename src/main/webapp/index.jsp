...
<body>
    ...
    <div class="conter_con">
        <ul class="list_con fl">
            ...
            <li id="news0">
                <a href="detail.jsp?num=${ newsId[0] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news1">
                <a href="detail.jsp?num=${ newsId[1] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news2">
                <a href="detail.jsp?num=${ newsId[2] }" class="news_pic fl"  ><img src="images/news_pic.jpg"></a>
            ...
            <li id="news3">
                <a href="detail.jsp?num=${ newsId[3] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news4">
                <a href="detail.jsp?num=${ newsId[4] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news5">
                <a href="detail.jsp?num=${ newsId[5] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news6">
                <a href="detail.jsp?num=${ newsId[6] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news7">
                <a href="detail.jsp?num=${ newsId[7] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news8">
                <a href="detail.jsp?num=${ newsId[8] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
            ...
            <li id="news9">
                <a href="detail.jsp?num=${ newsId[9] }" class="news_pic fl"><img src="images/news_pic.jpg"></a>
