...
<div class="main-content">
  ...
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="advertiserServlet.do">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <select class="form-select" id="type" name="type">
                ...
                <c:forEach var="typeOption" items="${adTypes}">
                  <option value="${typeOption}" <c:if test="${typeOption == selectedType}">selected</c:if>>${typeOption}</option>
                </c:forEach>
              </select>
            </div>
            <!-- 网站选择 -->
            <div class="col-md-3">
              ...
              <select class="form-select" id="website" name="website">
                <option value="" <c:if test="${empty selectedWebsite}">selected</c:if>>所有网站</option>
                <option value="${applicationScope.NEWS_SITE}"
                        <c:if test="${applicationScope.NEWS_SITE == selectedWebsite}">selected</c:if>>新闻</option>
                <option value="${applicationScope.BOOK_SITE}"
                        <c:if test="${applicationScope.BOOK_SITE == selectedWebsite}">selected</c:if>>书城</option>
              </select>
            </div>
            <!-- 开始日期选择 -->
            <div class="col-md-3">
          ...
          <div class="mt-4 d-flex justify-content-between">
            ...
            <div>
              ...
              <a href="advertiserServlet.do?method=adAnalysis" class="btn btn-secondary">重置</a>
            </div>
          </div>
        </form>
      </div>
