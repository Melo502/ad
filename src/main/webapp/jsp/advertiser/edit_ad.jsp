        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <form action="advertiserServlet.do" method="post" enctype="multipart/form-data">
                    ...
                    <!-- 广告状态 -->
                    <div class="mb-3">
                        <label for="status" class="form-label">广告状态</label>
                        <select class="form-select" id="status" name="status" required>
                            <option value="">请选择广告状态</option>
                            <option value="活跃" <c:if test="${ad.status == '活跃'}">selected</c:if>>活跃</option>
                            <option value="停用" <c:if test="${ad.status == '停用'}">selected</c:if>>停用</option>
                        </select>
                    </div>
