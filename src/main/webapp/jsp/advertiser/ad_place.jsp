            ...
            <form action="advertiserServlet.do" method="post">
                ...
                <div class="form-group">
                    ...
                    <select id="website" name="website" class="form-control" required>
                        ...
                        <option value="http://localhost:8080/advertise_war_exploded/jsp/advertiser/test.jsp">新闻</option>
                        <option value="http://localhost:8080/advertise_war_exploded/jsp/advertiser/test.jsp">书城</option>
                        <!-- 添加更多网站选项 -->
                    </select>
                </div>
