    ...
    <c:if test="${not empty ad}">
        ...
        <div class="row mt-4">
            <div class="col text-center">
                <a href="adminServlet.do?method=editAd&id=${ad.id}" class="btn btn-warning me-2">
                ...
                <a href="adminServlet.do?method=viewAdRecords" class="btn btn-secondary ms-2">返回列表</a>
            </div>
        </div>
    </c:if>
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="text-center">
                    <a href="adminServlet.do?method=viewAdRecords" class="btn btn-primary">返回列表</a>
                </div>
            </div>
        </div>
    </c:if>
