...
<%@ page import="com.example.news.jdbc.dao.NewsDao" %>
<%@ page import="com.example.news.jdbc.model.News" %>
...
<body>
    <div class="header_con">
        <div class="header">
            ...
            <ul class="menu fl">
                ...
                <li class="active" data-cid="2"><a href="javascript:;">国际</a></li>
                <li data-cid="3"><a href="index4.jsp">军事</a></li>
                <li data-cid="4"><a href="index5.jsp">金融</a></li>
                <li data-cid="5"><a href="index6.jsp">体育</a></li>
            </ul>
	...
	List<News> list = newsDao.searchNewsBySectionTopTen(3);
    ...
    <div class="conter_con">
        <ul class="list_con fl">
            ...
            <li id="news0">
                <a href="detail.jsp?num=${ newsId[0] }" class="news_pic fl"><img src="images/s310.jpeg"></a>
            ...
            <li id="news1">
                <a href="detail.jsp?num=${ newsId[1] }" class="news_pic fl"><img src="images/s301.jpeg"></a>
            ...
            <li id="news2">
                <a href="detail.jsp?num=${ newsId[2] }" class="news_pic fl"  ><img src="images/s302.jpeg"></a>
            ...
            <li id="news3">
                <a href="detail.jsp?num=${ newsId[3] }" class="news_pic fl"><img src="images/s303.jpeg"></a>
            ...
            <li id="news4">
                <a href="detail.jsp?num=${ newsId[4] }" class="news_pic fl"><img src="images/s304.jpeg"></a>
            ...
            <li id="news5">
                <a href="detail.jsp?num=${ newsId[5] }" class="news_pic fl"><img src="images/s305.jpeg"></a>
            ...
            <li id="news6">
                <a href="detail.jsp?num=${ newsId[6] }" class="news_pic fl"><img src="images/s306.jpeg"></a>
            ...
            <li id="news7">
                <a href="detail.jsp?num=${ newsId[7] }" class="news_pic fl"><img src="images/s307.jpeg"></a>
            ...
            <li id="news8">
                <a href="detail.jsp?num=${ newsId[8] }" class="news_pic fl"><img src="images/s308.jpeg"></a>
            ...
            <li id="news9">
                <a href="detail.jsp?num=${ newsId[9] }" class="news_pic fl"><img src="images/s309.jpeg"></a>
