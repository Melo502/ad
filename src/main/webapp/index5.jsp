...
<body>
    <div class="header_con">
        <div class="header">
            ...
            <ul class="menu fl">
                ...
                <li class="active" data-cid="4"><a href="javascript:;">金融</a></li>
	...
	List<News> list = newsDao.searchNewsBySectionTopTen(5);
    ...
    <div class="conter_con">
        <ul class="list_con fl">
            ...
            <li id="news0">
                <a href="detail.jsp?num=${ newsId[0] }" class="news_pic fl"><img src="images/s501.jpg"></a>
            ...
            <li id="news1">
                <a href="detail.jsp?num=${ newsId[1] }" class="news_pic fl"><img src="images/s502.jpg"></a>
            ...
            <li id="news2">
                <a href="detail.jsp?num=${ newsId[2] }" class="news_pic fl"  ><img src="images/s503.jpg"></a>
            ...
            <li id="news3">
                <a href="detail.jsp?num=${ newsId[3] }" class="news_pic fl"><img src="images/s504.jpg"></a>
            ...
            <li id="news4">
                <a href="detail.jsp?num=${ newsId[4] }" class="news_pic fl"><img src="images/s505.jpg"></a>
            ...
            <li id="news5">
                <a href="detail.jsp?num=${ newsId[5] }" class="news_pic fl"><img src="images/s506.png"></a>
            ...
            <li id="news6">
                <a href="detail.jsp?num=${ newsId[6] }" class="news_pic fl"><img src="images/s507.jpg"></a>
            ...
            <li id="news7">
                <a href="detail.jsp?num=${ newsId[7] }" class="news_pic fl"><img src="images/s508.jpg"></a>
            ...
            <li id="news8">
                <a href="detail.jsp?num=${ newsId[8] }" class="news_pic fl"><img src="images/s509.jpg"></a>
            ...
            <li id="news9">
                <a href="detail.jsp?num=${ newsId[9] }" class="news_pic fl"><img src="images/s510.jpg"></a>
