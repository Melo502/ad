...
<body>
    <div class="header_con">
        <div class="header">
            ...
            <ul class="menu fl">
                ...
                <li class="active" data-cid="1"><a href="javascript:;">国内</a></li>
    ...
    <div class="conter_con">
        <ul class="list_con fl">
            ...
            <li id="news0">
                <a href="detail.jsp?num=${ newsId[0] }" class="news_pic fl"><img src="images/s201.jpeg"></a>
            ...
            <li id="news1">
                <a href="detail.jsp?num=${ newsId[1] }" class="news_pic fl"><img src="images/s202.jpeg"></a>
            ...
            <li id="news2">
                <a href="detail.jsp?num=${ newsId[2] }" class="news_pic fl"  ><img src="images/s203.jpeg"></a>
            ...
            <li id="news3">
                <a href="detail.jsp?num=${ newsId[3] }" class="news_pic fl"><img src="images/s204.jpeg"></a>
            ...
            <li id="news4">
                <a href="detail.jsp?num=${ newsId[4] }" class="news_pic fl"><img src="images/s205.jpeg"></a>
            ...
            <li id="news5">
                <a href="detail.jsp?num=${ newsId[5] }" class="news_pic fl"><img src="images/s206.jpeg"></a>
            ...
            <li id="news6">
                <a href="detail.jsp?num=${ newsId[6] }" class="news_pic fl"><img src="images/s207.jpeg"></a>
            ...
            <li id="news7">
                <a href="detail.jsp?num=${ newsId[7] }" class="news_pic fl"><img src="images/s208.jpeg"></a>
            ...
            <li id="news8">
                <a href="detail.jsp?num=${ newsId[8] }" class="news_pic fl"><img src="images/s209.jpeg"></a>
            ...
            <li id="news9">
                <a href="detail.jsp?num=${ newsId[9] }" class="news_pic fl"><img src="images/s210.jpeg"></a>
